...
/**
 * @file Fill grid values to generate solution.
 * @author James Reid
 */
...
const fillGridValues = grid => {
    ...
    for (let i = 0; i < 36; i++) {
        ...
        // control this and other timers/counters from the batch generate
        // script in order to speed up generation
        // stats on non-rejected solved grids - used to inform rejection
        // threshold for solved grid raw entropy
